...
<div class="modal-body">
	...
	<div class="row">
		<div class="col-xs-4">
			...
			{{ csrf_field() }}
			<input type="hidden" name="referenceId" value="{{$dest->id}}">
			<input type="hidden" name="folder" value="destinations">
